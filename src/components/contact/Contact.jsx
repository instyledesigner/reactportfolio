...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_0ryqkek', 'template_la182it', form.current, 'kD7RQcECXp-j7ENRp')
    e.target.reset()
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>WhatsApp</h4>
            <a href="https://api.whatsapp.com/send?phone+918401065610" target='_blank'>Send a message</a>
          </article>
        </div>
